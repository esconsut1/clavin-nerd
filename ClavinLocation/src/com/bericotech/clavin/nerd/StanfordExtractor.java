...
public class StanfordExtractor implements LocationExtractor {
    ...
    public StanfordExtractor(String NERmodel, String NERprop) throws IOException, ClassCastException, ClassNotFoundException {
    	...
    	InputStream mpis = this.getClass().getClassLoader().getResourceAsStream("resources/models/" + NERprop);
    	Properties mp = new Properties();
    	mp.load(mpis);
    	
       	
    	namedEntityRecognizer = (AbstractSequenceClassifier<CoreMap>) 
                CRFClassifier.getJarClassifier("/resources/models/" + NERmodel, mp);
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("resources/Demonyms.txt")));
